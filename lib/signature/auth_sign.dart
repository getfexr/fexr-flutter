 ...
 */
  ...
  String recombinedResult = Dependencies().getPos(senderWalletID.toString(), signature.join());
  
  List<int> positionsLevelZero = new List<int>.generate(32, (index) => 0, growable: false);
  for (int k = 0; k < 32; k++) {
