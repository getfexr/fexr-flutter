...
class RubixServiceClient extends $grpc.Client {
  ...
  static final _$generateRbt =
      $grpc.ClientMethod<$1.GenerateReq, $1.RequestTransactionPayloadRes>(
          ...
          ($core.List<$core.int> value) =>
              $1.RequestTransactionPayloadRes.fromBuffer(value));
  static final _$getBalance = $grpc.ClientMethod<$0.Empty, $1.GetBalanceRes>(
      '/protos.RubixService/GetBalance',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetBalanceRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.GetBalanceRes> getBalance($0.Empty request,
      {$grpc.CallOptions? options}) {
...
abstract class RubixServiceBase extends $grpc.Service {
  ...
  RubixServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$1.GenerateReq, $1.RequestTransactionPayloadRes>(
            ...
            ($1.RequestTransactionPayloadRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.Empty, $1.GetBalanceRes>(
        'GetBalance',
        getBalance_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($1.GetBalanceRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$1.GetBalanceRes> getBalance_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
  ...
  $async.Future<$1.GetBalanceRes> getBalance(
      $grpc.ServiceCall call, $0.Empty request);
}
